...
const { addClientHistory , searchClientHistorys ,getClientHistorys ,updateClientHistory, isNumberAvailable, deleteClientHistory, deleteClientHistorySoft } = require("../controller/clientHistory.controller")
...
clientHistoryRoutes.put('/DeleteClientHistory',isAuth('ALL'),deleteClientHistorySoft) ;
